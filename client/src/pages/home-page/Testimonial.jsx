...
function Testimonial() {
  return <div className="font-sans flex flex-col items-center py-16 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-white">
      {}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full max-w-6xl">
        ...
        <div className="bg-white/80 dark:bg-black/50 p-8 rounded-xl flex flex-col justify-between border border-gray-200 dark:border-gray-800 backdrop-blur-sm shadow-md">
          ...
          <div className="flex items-center">
            <img src="https://i.pinimg.com/736x/6f/a3/6a/6fa36aa2c367da06b2a4c8ae1cf9ee02.jpg" alt="Shekinah Tshikulila" className="w-12 h-12 rounded-full object-cover mr-4" onError={e => {
            e.target.onerror = null;
            e.target.src = "https://placehold.co/48x48/6B7280/FFFFFF?text=ST";
          }} />
            <div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white/80 dark:bg-black/50 p-8 rounded-xl flex flex-col justify-between border border-gray-200 dark:border-gray-800 backdrop-blur-sm shadow-md">
            ...
            <div className="flex items-center">
              <img src="https://i.pinimg.com/736x/89/4e/16/894e16749bb2800527958cf7813b998e.jpg" alt="Jonathan Yombo" className="w-12 h-12 rounded-full object-cover mr-4" onError={e => {
              e.target.onerror = null;
              e.target.src = "https://placehold.co/48x48/6B7280/FFFFFF?text=JY";
            }} />
              <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white/80 dark:bg-black/50 p-6 rounded-xl flex flex-col justify-between border border-gray-200 dark:border-gray-800 backdrop-blur-sm shadow-md">
              ...
              <div className="flex items-center">
                <img src="https://i.pinimg.com/736x/5a/ac/66/5aac6619a8b81993b10be58fbded3951.jpg" alt="Yucel Farukşahan" className="w-10 h-10 rounded-full object-cover mr-3" onError={e => {
                e.target.onerror = null;
                e.target.src = "https://placehold.co/40x40/6B7280/FFFFFF?text=YF";
              }} />
                <div>
            ...
            <div className="bg-white/80 dark:bg-black/50 p-6 rounded-xl flex flex-col justify-between border border-gray-200 dark:border-gray-800 backdrop-blur-sm shadow-md">
              ...
              <div className="flex items-center">
                <img src="https://i.pinimg.com/736x/d9/7f/aa/d97faa4ca82603ea39b68b534f63b89a.jpg" alt="Rodrigo Aguilar" className="w-10 h-10 rounded-full object-cover mr-3" onError={e => {
                e.target.onerror = null;
                e.target.src = "https://placehold.co/40x40/6B7280/FFFFFF?text=RA";
              }} />
                <div>
